...
const LearnMore = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--gradient-canva-bg)' }}>
      ...
      {/* Hero Section */}
      <section id="hero" className="py-6 px-[10px] md:px-4">
      ...
      {/* Problem Section */}
      <section id="problem" className="py-6 px-[10px] md:px-4">
      ...
      <section id="checkins" className="py-6 px-[10px] md:px-4">
      ...
      {/* Framework Section */}
      <section id="framework" className="py-6 px-[10px] md:px-4">
        <div className="mx-auto max-w-3xl">
      ...
      {/* Proof Section */}
      <section id="proof" className="py-6 px-[10px] md:px-4">
        <div className="mx-auto max-w-3xl">
      ...
      {/* Stories Section */}
      <section id="stories" className="py-6 px-[10px] md:px-4">
        <div className="mx-auto max-w-4xl">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-6 px-[10px] md:px-4">
        <div className="mx-auto max-w-3xl">
      ...
      {/* Final CTA */}
      <section id="cta" className="py-6 px-[10px] md:px-4">
