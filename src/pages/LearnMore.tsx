      ...
      <section id="checkins" className="py-6 px-1.5">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white/70 backdrop-blur-sm border-2 border-transparent bg-clip-padding relative rounded-3xl p-2.5" style={{ backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
            ...
            <div className="flex gap-4 p-2.5 rounded-2xl bg-white/80 border-2 border-transparent bg-clip-padding relative md:col-span-2" style={{ backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
      ...
      <section id="proof" className="py-6 px-1.5">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-1.5">
            <div className="bg-white/70 backdrop-blur-sm border-2 border-transparent bg-clip-padding relative rounded-2xl p-2.5" style={{ backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
              <p className="text-muted-foreground">
      ...
      <section id="stories" className="py-6 px-1.5">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-1.5">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-2.5 border-2 border-transparent bg-clip-padding relative" style={{ backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
              <p className="text-muted-foreground">
