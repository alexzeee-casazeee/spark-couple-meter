    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-3 py-2 text-center">
        <div className="max-w-4xl mx-auto space-y-2 animate-fade-in">
          ...
          <div className="max-w-2xl mx-auto bg-white/80 backdrop-blur-md rounded-3xl p-4 border-2 border-primary/60 bg-clip-padding relative mt-4" style={{
      ...
      <section className="container mx-auto px-[5px] md:px-4 py-8">
        <div className="max-w-6xl mx-auto bg-white/70 backdrop-blur-sm p-[6px] rounded-3xl border-2 border-primary/60" style={{ boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
          ...
          <div className="space-y-5 px-[5px] md:px-6 pb-[5px] md:pb-6">
            <div className="bg-white/80 p-4 rounded-2xl border-2 border-primary/60 bg-clip-padding relative" style={{ backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
      ...
      <section className="container mx-auto px-[5px] md:px-4 py-8">
        <div className="max-w-md mx-auto w-full">
          <div className="rounded-2xl shadow-2xl border-2 border-primary/60 overflow-hidden bg-canva-gradient">
            <Dashboard 
              demoMode={true} 
              onDemoInteraction={() => {
      ...
      <section className="container mx-auto px-[5px] md:px-4 py-8">
        <div className="max-w-6xl mx-auto bg-white/70 backdrop-blur-sm p-[6px] rounded-3xl border-2 border-primary/60" style={{ boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
          ...
          <div className="space-y-4 px-[5px] md:px-6 pb-[5px] md:pb-6">
            <div className="bg-white/80 p-5 rounded-2xl border-2 border-primary/60" style={{ boxShadow: '0 4px 20px rgba(0, 0, 0, 0.08)' }}>
      ...
      <section className="container mx-auto px-[5px] md:px-4 py-12">
        <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-md rounded-3xl p-8 md:p-12 border-2 border-primary/60 bg-clip-padding relative" style={{ 
          backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', 
          backgroundOrigin: 'border-box', 
          backgroundClip: 'padding-box, border-box',
          boxShadow: '0 20px 60px rgba(0, 0, 0, 0.15)'
      ...
      <section className="container mx-auto px-[5px] md:px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white/80 p-6 rounded-2xl border-2 border-primary/60 bg-clip-padding relative" style={{ backgroundImage: 'linear-gradient(white, white), linear-gradient(135deg, hsl(180, 70%, 75%), hsl(280, 60%, 75%))', backgroundOrigin: 'border-box', backgroundClip: 'padding-box, border-box', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
      ...
      {/* FAQ Section */}
      <section className="container mx-auto px-[5px] md:px-4 py-8">
        <div className="max-w-4xl mx-auto bg-white/70 backdrop-blur-sm p-6 md:p-8 rounded-3xl border-2 border-primary/60" style={{ boxShadow: '0 8px 32px rgba(0, 0, 0, 0.12)' }}>
          <div className="text-center mb-8">
